...
export const mockPosts: Post[] = [
  {
    ...
    content: 'This is the first post on our portal. We are excited to share the latest research and insights about labour studies in Vietnam.',
  ...
  {
    id: '3',
    slug: 'upcoming-conference-on-labour-rights',
    title: 'Upcoming Conference on Labour Rights',
    content: 'Join us for the annual conference on labour rights in Southeast Asia. This year we will focus on digitalization and its impact on worker protections.',
    excerpt: 'Annual conference focusing on labour rights and digitalization in Southeast Asia',
    authorId: 'admin-1',
    category: 'event',
    tags: ['conference', 'labour-rights', 'southeast-asia'],
